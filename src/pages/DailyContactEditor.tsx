...
export default function DailyContactEditor() {
  ...
  const saveLesson = useMutation({
    ...
    onSuccess: (data) => {
      ...
      toast({
        title: "Sucesso!",
        description: `Daily Contact ${lessonId ? 'atualizado' : 'criado'} com sucesso.`,
      });
      if (!lessonId) {
        navigate(`/editor/daily-contact/${data.id}`);
      }
    },
    onError: (error) => {
      toast({
  ...
  const deleteLesson = useMutation({
    ...
    onSuccess: () => {
      ...
      toast({
        title: "Sucesso!",
        description: "Daily Contact excluído com sucesso.",
      });
      navigate('/dashboard');
    },
    onError: (error) => {
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        <div className="flex justify-between items-center">
          ...
          <h1 className="text-2xl font-bold">
            {lessonId ? 'Editar Daily Contact' : 'Criar Novo Daily Contact'}
          </h1>
          <div className="flex gap-2">
            ...
            <Button onClick={handleSave} disabled={saveLesson.isPending}>
              ...
              {saveLesson.isPending ? 'Salvando...' : 'Salvar Daily Contact'}
            </Button>
          </div>
        </div>
        ...
        <Card>
          <CardHeader>
            <CardTitle>Detalhes do Daily Contact</CardTitle>
          </CardHeader>
