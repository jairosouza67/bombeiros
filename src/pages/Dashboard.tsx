  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-primary/5 pb-20 md:pb-0">
      <header className="border-b border-border bg-card/50 backdrop-blur-sm sticky top-0 z-10">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            {isKeyUser && (
              <Button variant="secondary" size="sm" onClick={() => navigate('/editor/daily-contact')}>
      ...
      <main className="container mx-auto px-4 py-8 space-y-8">
          ...
          <Card className="hover:shadow-lg transition-shadow">
            ...
            <CardContent>
              <div className="space-y-4">
                ...
                <Button className="w-full" onClick={() => navigate('/daily-contact')}>
                  Ir para Daily Contact
                </Button>
              </div>
            </CardContent>
          </Card>
        ...
        <Card>
          <CardHeader>
            <CardTitle>Próximos Daily Contacts</CardTitle>
            <CardDescription>Daily Contacts agendados para hoje</CardDescription>
          </CardHeader>
          <CardContent>
            {lessons && lessons.length > 0 ? (
              ...
              <p className="text-center text-muted-foreground py-8">
                Nenhum Daily Contact disponível ainda
              </p>
            )}
          </CardContent>
        </Card>
